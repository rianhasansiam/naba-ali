    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-7 gap-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-green-600 mt-1 price-number">BDT {totalRevenue.toFixed(2)}</p>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-lg font-bold text-green-600 price-number">BDT {order.total}</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="space-y-2">
                    {order.products.map((item, itemIndex) => (
                      <div key={`${order.id}-product-${itemIndex}-${item.name}`} className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="text-right">
                          <p className="font-medium price-number">BDT {item.price}</p>
                          <p className="text-sm text-gray-500 price-number">BDT {(item.price * item.quantity).toFixed(2)}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                      ...
                      selectedOrder.products.map((item, index) => (
                        <div key={`modal-product-${index}-${item.name}-${item.quantity}`} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 price-number">Unit Price: BDT {item.price}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-sm text-gray-600 price-number">Unit Price: BDT {item.price}</p>
                          ...
                          <div className="text-right">
                            <p className="font-semibold text-lg price-number">BDT {(item.price * item.quantity).toFixed(2)}</p>
                          </div>
                        </div>
                      ))
                    ) : (
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-gray-900 price-number">BDT {selectedOrder.subtotal || 0}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Shipping:</span>
                        <span className="text-gray-900 price-number">BDT {selectedOrder.shipping || 0}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-gray-600">Tax:</span>
                        <span className="text-gray-900 price-number">BDT {selectedOrder.tax || 0}</span>
                      </div>
                      <div className="flex justify-between text-lg font-bold border-t pt-2">
                        <span className="text-gray-900">Total:</span>
                        <span className="text-green-600 price-number">BDT {selectedOrder.total}</span>
                      </div>
                    </div>
                  </div>
                </div>
