...
const DeleteConfirmationDialog = ({ isOpen, onClose, onConfirm, categoryName, isLoading }) => {
          ...
          <div className="p-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <p className="text-sm text-red-600">
                <strong>Warning:</strong> This action cannot be undone. Deleting this category will:
              </p>
              <ul className="text-sm text-red-600 mt-2 list-disc list-inside space-y-1">
                <li>Remove the category permanently</li>
                <li>Affect products currently assigned to this category</li>
                <li>Update your category statistics</li>
              </ul>
            </div>
          </div>
