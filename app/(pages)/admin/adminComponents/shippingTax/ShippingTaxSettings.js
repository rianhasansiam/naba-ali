          ...
          <div className="bg-white rounded-lg p-4 border">
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span>Sample Order (BDT 8,500.00):</span>
                <span className="price-number">BDT 8,500.00</span>
              </div>
              {settings.shippingSettings.enabled && (
                <div className="flex justify-between">
                  <span>Shipping:</span>
                  <span className="price-number">BDT {settings.shippingSettings.shippingCharge || '0.00'}</span>
                </div>
              )}
              {settings.taxSettings.enabled && (
                <div className="flex justify-between">
                  <span>{settings.taxSettings.taxName}:</span>
                  <span className="price-number">BDT {((100 * (settings.taxSettings.taxRate || 0)) / 100).toFixed(2)}</span>
                </div>
              )}
