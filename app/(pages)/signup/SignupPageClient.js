        ...
        >
          ...
          {signupData.authConfig.enableGoogleSignup && (
            <motion.button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              variants={itemVariants}
            ...
            >
              ...
              {isLoading ? 'Creating account...' : signupData.formData.googleButtonText}
            </motion.button>
          )}
