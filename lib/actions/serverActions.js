...
export async function getServerSideData(dataType, options = {}) {
  ...
  console.log(`🔄 Server Action: Fetching ${dataType} data...`)
  ...
  try {
    ...
    console.log(`✅ Server Action: ${dataType} data retrieved (${Array.isArray(data) ? data.length : 'object'} items)`)
    ...
    console.error(`❌ Server Action: ${dataType} fetch failed:`, error)
...
export async function getProductById(productId) {
  ...
  try {
    console.log(`🔄 Server Action: Fetching product ${productId}...`)
    ...
    console.log(`✅ Server Action: Product ${productId} retrieved with ${relatedProducts.length} related products`)
    ...
    console.error(`❌ Server Action: Product ${productId} fetch failed:`, error)
...
export async function getUserData(userId, dataTypes = ['orders']) {
  ...
  try {
    console.log(`🔄 Server Action: Fetching user data for ${userId}...`)
    ...
    console.log(`✅ Server Action: User ${userId} data retrieved`)
    ...
    console.error(`❌ Server Action: User ${userId} data fetch failed:`, error)
...
export async function getAdminDashboardData() {
  ...
  try {
    console.log('🔄 Server Action: Fetching admin dashboard data...')
    ...
    console.log('✅ Server Action: Admin dashboard data retrieved')
...
export async function searchData(query, filters = {}) {
  ...
  try {
    ...
    console.log(`✅ Server Action: Search completed with ${totalResults} results`)
    ...
    console.error(`❌ Server Action: Search failed for "${query}":`, error)
